      ...
      res.data.forEach(msg => {
        ...
        if (!convMap.has(otherId)) {
          convMap.set(otherId, {
            ...
            name: otherName,
            role: otherRole,
            lastMessage: msg.message || (msg.attachment_name ? `Attachment: ${msg.attachment_name}` : ''),
    ...
    <>
      ...
      <Box sx={{ height: 'calc(100vh - 64px)', bgcolor: '#f4f8f6', display: 'flex', flexDirection: 'column' }}>
        ...
        <Container maxWidth="xl" sx={{ height: '100%', py: 2, px: { xs: 1, md: 2 } }}>
          <Paper sx={{ display: 'flex', height: '100%', overflow: 'hidden', borderRadius: 4, border: '1px solid #e9efec', boxShadow: '0 20px 50px -30px rgba(10,31,26,0.35)' }}>
                      ...
                      >
                        ...
                        <Box sx={{ flex: 1, overflow: 'hidden' }}>
                          ...
                          <Typography variant="caption" color="text.secondary" noWrap sx={{ fontWeight: unreadCounts[conv.id] > 0 ? 'bold' : 'normal' }}>
                            {conv.lastMessageIsAttachment ? 'Attachment: ' : ''}{conv.lastMessage?.substring(0, 40)}
                          </Typography>
                        </Box>
                            ...
                            >
                              <Paper
                                ...
                                sx={{
                                  ...
                                  bgcolor: msg.sender_id === user.id ? '#10b981' : 'white',
                                  color: msg.sender_id === user.id ? 'white' : '#0a1f1a',
                                  border: msg.sender_id === user.id ? 'none' : '1px solid #e9efec',
                                  borderRadius: msg.sender_id === user.id ? '16px 16px 4px 16px' : '16px 16px 16px 4px',
                                  boxShadow: '0 2px 8px -4px rgba(10,31,26,0.25)',
                                  position: 'relative',
                                  cursor: 'pointer',
                                ...
                                {replyTo && (
                                  <Box sx={{ mb: 1, p: 1, bgcolor: 'rgba(0,0,0,0.05)', borderRadius: 1, borderLeft: `3px solid #10b981` }}>
                                    ...
                                    <Typography variant="caption" color="text.secondary" sx={{ display: 'block' }}>
                                      {replyTo.message?.substring(0, 60) || (replyTo.attachment_name ? `Attachment: ${replyTo.attachment_name}` : '')}
                                    </Typography>
                                  </Box>
                                )}
