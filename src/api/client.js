...
export const getMySchedules = () => api.get('/schedules/mine')
...
export const pauseSchedule = (scheduleId) => api.put(`/schedules/${scheduleId}/pause`)
export const resumeSchedule = (scheduleId) => api.put(`/schedules/${scheduleId}/resume`)
export const cancelSchedule = (scheduleId) => api.put(`/schedules/${scheduleId}/cancel`)
