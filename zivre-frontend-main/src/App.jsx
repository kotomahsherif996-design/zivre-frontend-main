...
const theme = createTheme({
  ...
  palette: {
    primary: { main: '#10b981', light: '#34d399', dark: '#0f3b2c' },
    ...
    text: { primary: '#0a1f1a', secondary: '#5b6b66' },
  },
  typography: {
    fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif',
    h1: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '2.5rem', fontWeight: 800, letterSpacing: '-0.03em' },
    h2: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.02em' },
    h3: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '1.5rem', fontWeight: 700, letterSpacing: '-0.01em' },
    h4: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '1.25rem', fontWeight: 700 },
    h5: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '1.125rem', fontWeight: 600 },
    h6: { fontFamily: '"Sora", "Inter", sans-serif', fontSize: '1rem', fontWeight: 600 },
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: { textTransform: 'none', borderRadius: 10, fontWeight: 600, padding: '8px 18px', boxShadow: 'none' },
        containedPrimary: {
          backgroundImage: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
          boxShadow: '0 6px 16px -6px rgba(16,185,129,0.5)',
          '&:hover': { backgroundImage: 'linear-gradient(135deg, #059669 0%, #047857 100%)', boxShadow: '0 8px 20px -6px rgba(16,185,129,0.6)' }
        },
      },
